...
xdecoded=decoding001(BestGene,Nvar,BitArray,xmax,xmin);% Decoding process
    ...
    %fxj=DB1max/D1limit+DB2max/D2limit+Umax/(5*Ulimit)
    %fxj=DB1max/D1limit+DB2max/D2limit
    fxj=ZB1max/ZB1limit+ZB2max/ZB2limit
